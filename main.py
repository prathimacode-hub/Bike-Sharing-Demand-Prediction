...
add_selectbox = st.sidebar.radio(
    "",
    ("About", "Bike Sharing Prediction for Day","Bike Sharing Prediction for Hour", "Work")
)
...
if add_selectbox == 'About':
	...
	st.markdown('• <a href="https://www.linkedin.com/in/prathimacode-hub/">Prathima Kadari</a>', unsafe_allow_html=True)
